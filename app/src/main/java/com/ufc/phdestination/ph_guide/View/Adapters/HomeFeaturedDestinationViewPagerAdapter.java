...
public class HomeFeaturedDestinationViewPagerAdapter extends PagerAdapter {


    private static final String TAG = "HomeFeaturedDestinationViewPagerAdapter";

    List<Destination> featuredDestinationList = new ArrayList<Destination>();
    Destination destination;
    private Context mContext;

    public HomeFeaturedDestinationViewPagerAdapter(Context mContext, List<Destination> destinationList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.main_home_featured_destination_viewpager_item, container, false);
...
//                        view.getContext().startActivity(intent, options.toBundle());
        ...
        Utilities.loadImageFromURL(this.mContext, progressBar, imageView, destination.getImage());
